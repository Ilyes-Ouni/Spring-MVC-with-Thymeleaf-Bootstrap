package com.livraison.projet.controllers;
...
public class ProduitController {
    ...
    public String saveProduit(@ModelAttribute("produit") Produit produit, @RequestParam("date") String date, ModelMap modelMap) throws
            ParseException {
